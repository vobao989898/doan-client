...
function DashBoard(props) {
        ...
        return (
          <li key={route.id} className="nav-item">
            <Link key={route.id} to={`/ThuongHieu=${route.id}`}>
              <div
                className={
                  route.ten_loai_giay === "Alexander McQueen" ||
                    route.ten_loai_giay === "Balenciaga" ||
                    route.ten_loai_giay === "Supreme"
                    ? "img-menu img-menuMcQueen"
                    : "img-menu"
                }
              >
                {route.ten_loai_giay === "Alexander McQueen" ? (
                  <div className="logoMcQueen">McQueen</div>
                ) : route.ten_loai_giay === "Supreme" ? (
                  <div className="logoMcQueen">Supreme</div>
                ) : route.ten_loai_giay === "Balenciaga" ? (
                  <div className="logoMcQueen">Balenciaga</div>
                ) : (
                  <img src="" alt=""></img>
                )}
              </div>
  ...
  function onSubmit(e) {
    e.preventDefault();
    history.push(
      `/TimKiem/Search=${query}&&SortBy=ten_giay&&GroupBy=desc&&MauSac=0&&From=0&&To=0&&Page=1`
    );
  }
        ...
        <div className="container">
          ...
          <div className="texttop">
            <ul className="text">
              <li
                className="cursor"
                onClick={() => history.push(`/TraCuuDonHang`)}
              >
                <p>Check hàng</p> <span>Mới thanh toán</span>
              </li>
              <li
                className="cursor"
                onClick={() => history.push(`/ChinhSachBaoHanh`)}
              >
          ...
          <div className="header">
            ...
            <div className="account account befores">
              <Link to="/DangNhap" title="Đăng ký & tạo tài khoản">
                ...
                {tokens && tokens.ten_khach_hang ? (
                  <span>{`Xin chào ${tokens.ten_khach_hang}`}</span>
                ) : (
