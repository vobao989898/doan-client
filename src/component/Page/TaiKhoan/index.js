...
function TaiKhoan(props) {
  ...
  const responseFacebook = (response) => {
    api
      .getFBID({ facebook_id: response.id })
      .then((responses) => {
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12">
            ...
            <div className="text-center fix-sblock">
              ...
              <div className="col-sm-12 margin-top">
                <div className="form-group mb-3">
                  ...
                  <input
                    ...
                    placeholder="NHẬP HỌ"
                  />
                  {errors.ho_khach_hang && (
                    <p className="error"> {errors.ho_khach_hang} </p>
                  )}
                </div>
              </div>
              <div className="col-sm-12 margin-top">
                <div className="form-group mb-3">
                  ...
                  {errors.ten_khach_hang && (
                    <p className="error"> {errors.ten_khach_hang} </p>
                  )}
                </div>
              </div>
              <div className="col-sm-12 margin-top">
