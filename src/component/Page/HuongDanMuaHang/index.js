...
function HuongDanMuaHang(props) {
	return (
		<div className="HuongDanMuaHang">
			<div class="container">
				<div className="title-huongdan text-center">HƯỚNG DẪN MUA HÀNG</div>
				<div className="row">
					<div className="col-xs-12 col-sm-12 col-md-12">
						<div className="content-page rte">
							...
							<p>
								<strong>Bước 2:</strong> Click và sản phẩm muốn mua, màn hình hiển thị ra pop up với các
								lựa chọn sau
							</p>
							...
							<p>
								<strong>Bước 4:</strong> Điền các thông tin của bạn để nhận đơn hàng, lựa chọn hình thức
